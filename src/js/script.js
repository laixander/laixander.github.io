...
var samples = new Vue({
    ...
    data: {
        samples: [
            {
                targetID: 'portfolio07Modal',
                imgSrc: '07.png',
                imgSrcFull: '07-full.png',
                imgAlt: 'Sample 07',
                visit: 'https://lancastertechdev.com/'
            },
            {
                targetID: 'portfolio06Modal',
                imgSrc: '06.png',
                imgSrcFull: '06-full.png',
                imgAlt: 'Sample 06',
                visit: 'https://centralizedinc.com/'
            },
            {
